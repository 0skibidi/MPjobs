...
exports.sendJobPostNotification = exports.sendEmail = exports.sendPasswordResetEmail = exports.sendVerificationEmail = void 0;
...
const sendJobPostNotification = async (employerEmail, employerName, jobTitle, jobId) => {
    const jobUrl = `${config_1.config.clientUrl}/jobs/${jobId}`;
    await transporter.sendMail({
        from: `"${config_1.config.appName}" <${config_1.config.emailFrom}>`,
        to: employerEmail,
...
exports.sendJobPostNotification = sendJobPostNotification;
